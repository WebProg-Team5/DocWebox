                            ...
                            <div class="header-navigation-area">
                                <ul class="main-menu nav justify-content-center">
                                    ...
                                    <?php if ($_SESSION['type'] === 'patient'){
                                        echo '<li id="searchDocs"><a href="searchDocs.php">Search Doctors</a></li>
                                                <li id="myAppointments"><a href="myAppointments.php">My Appointments</a></li>';
                ...
                <div class="table-responsive  table-sm mb-5">
                    <table class="table table-hover table-bordered">
                        ...
                        if(isset($appointments) ){
                            ...
                            echo '<a href="../patient/searchDocs.php" class="btn btn-block btn-danger col-sm-6 mx-auto mt-4 mb-4">
